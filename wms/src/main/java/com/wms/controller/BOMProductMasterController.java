...
public class BOMProductMasterController {
	...
	@PostMapping("/create")
	public ConfigBOMProductMaster create(@RequestBody ConfigBOMProductMaster bomProductMaster) {
	  return bomProductMasterService.createBOMProduct(bomProductMaster);
	}
	@PostMapping("/update")
	public void update() {
